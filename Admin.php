    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="Admin.php?Renderbody=SinhVien_Index">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Duy Thien</div>
                            <div class="card-body">
                                <?php
                                if (isset($_GET['Renderbody'])) 
                                {
                                    ...
                                    {
                                            // case "SinhVien_Index":
                                            //     require("Sinhvien_Index.php");
                                            //     break;
                                        case "SinhVien_Add":
                                            require("SinhVien_Add.php");
                                            break;
                                        case "SinhVien_Update":
                                            require("SinhVien_Update.php");
                                            break;
                                        default:
                                            require("Sinhvien_Index.php");
                                    }
